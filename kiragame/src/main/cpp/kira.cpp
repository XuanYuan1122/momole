...
Java_com_moemoe_lalala_kira_game_MapGameActivity_initNDK1(JNIEnv *env, jobject instance) {
...
EventError() {
    ...
    jclass jcls = (*env).FindClass("com/moemoe/lalala/kira/game/MapGameActivity");
...
showLog() {
    ...
    int attached = (*gJavaVM1).AttachCurrentThread(&env,NULL);
    jclass jcls = (*env).FindClass("com/moemoe/lalala/kira/game/MapGameActivity");
    jmethodID mid = (*env).GetMethodID(jcls,"showLog","(Ljava/lang/String;)V");
    (*env).CallVoidMethod(gCallbackObject1,mid);
}
