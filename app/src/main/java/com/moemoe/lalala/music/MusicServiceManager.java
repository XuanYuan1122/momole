...
/**
 * Created by Haru on 2016/3/23 0023.
 */
public class MusicServiceManager implements IConstants{
    ...
    public MusicInfo findMusicInfoByUrl(String url){
        if(mService != null) {
            try {
                return mService.findMusicInfoByUrl(url);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void addMusicInfo(MusicInfo musicInfo){
        if(mService != null) {
            try {
                mService.addMusicInfo(musicInfo);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
