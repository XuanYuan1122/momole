...
public class ShareMusicEntity implements Parcelable {
	...
	public static final Creator<ShareMusicEntity> CREATOR = new Creator<ShareMusicEntity>() {
		@Override
		public ShareMusicEntity createFromParcel(Parcel parcel) {
			ShareMusicEntity info = new ShareMusicEntity();
