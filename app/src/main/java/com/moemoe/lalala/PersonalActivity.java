...
public class PersonalActivity extends BaseActivity implements View.OnClickListener {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        Intent i1 = new Intent(PersonalActivity.this,SettingActivity.class);
                        startActivityForResult(i1, SettingActivity.REQUEST_SETTING_LOGOUT);
                        break;
                    default:
                        break;
                }
    ...
    private class InfoAdapter extends BaseAdapter{
        ...
        private String[] titles = {getString(R.string.label_my_post),getString(R.string.settings)};
        private int[] images = {R.drawable.icon_person_mydoc,R.drawable.icon_person_set};
