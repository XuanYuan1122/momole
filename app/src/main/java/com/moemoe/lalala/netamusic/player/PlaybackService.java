...
//            //TODO yi 歌曲图片
//            String path = currentSong.getCoverPath().startsWith("http://") || currentSong.getCoverPath().startsWith("https://")? currentSong.getCoverPath() : Otaku.URL_QINIU + currentSong.getCoverPath();
//            if(mNotification != null){
//                Picasso.with(this)
//                        .load(StringUtils.getUrl(this, path, DensityUtil.dip2px(100), DensityUtil.dip2px(100), false, true))
//                        .resize(DensityUtil.dip2px(100), DensityUtil.dip2px(100))
//                        .config(Bitmap.Config.RGB_565)//image_view_album
//                        .into(remoteView, R.id.image_view_album,NOTIFICATION_ID,mNotification);
//            }
//        }
//    }
//
