...
public class CalendarActivity extends BaseActivity implements IConstants {
...
//    }
    ...
    protected void initView() {
        ...
        mOneDayAdapter = new CalendarOneDayRecyclerViewAdapter(this, MapActivity.sMusicServiceManager);
        ...
        if(info != null && !TextUtils.isEmpty(info.musicName)){
            mTopMusicName.setText(info.musicName);
