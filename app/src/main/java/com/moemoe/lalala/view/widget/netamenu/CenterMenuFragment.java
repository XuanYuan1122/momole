...
import com.moemoe.lalala.utils.EventChoiceDecoration;
...
public class CenterMenuFragment extends DialogFragment{
    ...
    private CenterMenuItemAdapter menuItemAdapter;

    public CenterMenuFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.frag_center_menu, container, false);
        ...
        layoutManager.setOrientation(TYPE_VERTICAL);
        rv.setLayoutManager(layoutManager);
        rv.addItemDecoration(new EventChoiceDecoration());
        menuItemAdapter = new CenterMenuItemAdapter(getContext(),menuType, this.menuItems);
        menuItemAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                CenterMenuFragment.this.dismiss();
