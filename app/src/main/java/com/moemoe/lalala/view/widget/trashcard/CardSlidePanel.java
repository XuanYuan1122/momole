...
public class CardSlidePanel extends ViewGroup {
    ...
    private List<TrashEntity> dataList; // 存储的数据链表
    ...
    protected void onFinishInflate() {
        ...
        for (int i = num - 1; i >= 0; i--) {
            ...
            if (childView.getId() == R.id.card_bottom_layout) {
                ...
                viewItem.setTag(i + 1);
                viewItem.rlLayout.setOnClickListener(btnListener);
...
//        rightBtn.setOnClickListener(btnListener);
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top,
                                          int dx, int dy) {
            cardSwitchListener.onItemScroll(changedView,left);
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            cardSwitchListener.onRelease(releasedChild);
    ...
    private void orderViewStack() {
        ...
        if (newIndex < dataList.size()) {
            TrashEntity dataItem = dataList.get(newIndex);
    ...
    public interface CardSwitchListener {
        ...
        void onItemScroll(View cardImageView, int position);

        void onRelease(View releasedChild);
    }
}