...
public class PhoneJuQingV2Fragment extends BaseFragment implements IPhoneFragment{
    ...
    public static PhoneJuQingV2Fragment newInstance(){
        return new PhoneJuQingV2Fragment();
    }
