...
import com.moemoe.lalala.view.widget.map.utils.MapCalibrationData;
...
public class MapObject {
	...
	public MapObject(Object id, Drawable drawable, int x, int y, int pivotX, int pivotY, boolean isTouchable, boolean isScalable,boolean isVisible,int w,int h) {
		this.id = id;
	...
	public MapObject(Object id, Drawable drawable, int x, int y, int pivotX, int pivotY, boolean isTouchable, boolean isScalable) {
		this(id,drawable,x,y,pivotX,pivotY,isTouchable,isScalable,true,0,0);
	}

	public MapObject(Object id, Drawable drawable, int x, int y, int pivotX, int pivotY, boolean isTouchable, boolean isScalable,int w,int h) {
		this(id,drawable,x,y,pivotX,pivotY,isTouchable,isScalable,true,w,h);
	}
