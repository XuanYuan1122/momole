...
public class MyRoundedImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        mBorderOutSideColor = a.getColor(R.styleable.MyRoundedImageView_riv_border_outside_color, getResources().getColor(R.color.setting_gray));
        mBorderInsideColor = a.getColor(R.styleable.MyRoundedImageView_riv_border_inside_color, getResources().getColor(R.color.setting_gray));
        mRadii = new float[]{
