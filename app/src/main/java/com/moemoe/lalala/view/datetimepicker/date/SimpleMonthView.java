package com.moemoe.lalala.view.datetimepicker.date;
...
import com.moemoe.lalala.view.datetimepicker.Utils;
...
public class SimpleMonthView extends View {
	...
	public SimpleMonthView(Context context) {
		...
		mTodayNumberColor = resources.getColor(R.color.main_title_cyan);
