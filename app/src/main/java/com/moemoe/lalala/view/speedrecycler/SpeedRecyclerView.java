...
public class SpeedRecyclerView extends RecyclerView {
    ...
    public static final float FLING_SCALE_DOWN_FACTOR = 0.5f;//减速因子
    public static final int FLING_MAX_VELOCITY = 8000;//最大顺滑速度

    public SpeedRecyclerView(Context context){super(context);}
