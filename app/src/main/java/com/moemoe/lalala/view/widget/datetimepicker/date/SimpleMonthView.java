package com.moemoe.lalala.view.widget.datetimepicker.date;
...
import com.moemoe.lalala.view.widget.datetimepicker.Utils;
...
public class SimpleMonthView extends View {
	...
	public SimpleMonthView(Context context) {
		...
		mTodayNumberColor = resources.getColor(R.color.main_cyan);
		...
		MINI_DAY_NUMBER_TEXT_SIZE = resources.getDimensionPixelSize(R.dimen.size_16);
		MONTH_LABEL_TEXT_SIZE = resources.getDimensionPixelSize(R.dimen.size_16);
		MONTH_DAY_LABEL_TEXT_SIZE = resources.getDimensionPixelSize(R.dimen.size_10);
		MONTH_HEADER_SIZE = resources.getDimensionPixelOffset(R.dimen.size_50);
		DAY_SELECTED_CIRCLE_SIZE = resources.getDimensionPixelSize(R.dimen.size_16);

		mRowHeight = ((resources.getDimensionPixelOffset(R.dimen.size_270) - MONTH_HEADER_SIZE) / 6);
...
//	private SimpleDateFormat mSimpleDateFormat = new SimpleDateFormat("yyyy-")
	
	private String getMonthAndYearString() {
        int flags = DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_SHOW_YEAR | DateUtils.FORMAT_NO_MONTH_DAY;
        mStringBuilder.setLength(0);
        long millis = mCalendar.getTimeInMillis();
        String str = DateUtils.formatDateRange(getContext(), millis, millis, flags);
        return str;
    }
