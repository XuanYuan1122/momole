...
//	}
	...
	private void init() {
		...
		offset = mContext.getResources().getDimensionPixelSize(R.dimen.size_0);
//		offset = 0;	// 3.0后不需要偏移
		
		mMinPopWidth = mContext.getResources().getDimensionPixelSize(R.dimen.size_112);
...
//		}
	...
	private void measulWidthHeight(int location, View mAnchor) {
		int itemHeight = mContext.getResources().getDimensionPixelSize(R.dimen.size_40)
		...
		listWidth = mPaint.measureText(getLongestText())
				+ mContext.getResources().getDimensionPixelSize(R.dimen.size_50);
