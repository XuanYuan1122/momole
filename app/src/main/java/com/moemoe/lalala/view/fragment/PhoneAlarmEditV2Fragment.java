...
public class PhoneAlarmEditV2Fragment extends BaseFragment implements IPhoneFragment{
    ...
    public static PhoneAlarmEditV2Fragment newInstance(){
        return new PhoneAlarmEditV2Fragment();
    }

    public static PhoneAlarmEditV2Fragment newInstance(AlarmClockEntity entity){
        PhoneAlarmEditV2Fragment fragment = new PhoneAlarmEditV2Fragment();
