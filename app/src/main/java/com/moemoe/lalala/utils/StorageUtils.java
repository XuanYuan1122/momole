...
public class StorageUtils {
	...
	public static final void initialStorageDir(Context context) {
		...
		LogUtil.d("initialStorageDir = " + check + ", paths = " + sDirRoot + "; " + sDirTemp);
	}

	// public static File getClubIcon(String uuid){
	// if(!TextUtils.isEmpty(uuid)){
	// return new File(sDirIconImage + "club_" + uuid + ".png");
	// }else{
	// return null;
	// }
	// }

	// public static File getDocIcon(String uuid){
	// if(!TextUtils.isEmpty(uuid)){
	// return new File(sDirIconImage + "post_" + uuid + ".png");
	// }else{
	// return null;
	// }
	// }

	// public static File getIcon(String uuid){
	// if(!TextUtils.isEmpty(uuid)){
	// return new File(sDirIconImage + uuid + ".png");
	// }else{
	// return null;
	// }
	// }

	// public static File getIconByFileName(String filename){
	// if(!TextUtils.isEmpty(filename)){
	// return new File(sDirIconImage, filename);
	// }else{
	// return null;
	// }
	// }
	...
	public static String getThumbByFileName(String filename) {
		if (!TextUtils.isEmpty(filename)) {
			if (filename.toLowerCase().contains(".gif")) {
				...
				LogUtil.e("gif thumb change to : " + filename);
			}
	...
	// public static File getAvatarFile(String uuid){
	// if(!TextUtils.isEmpty(uuid)){
	// return new File(sDirAvatars + "avatar_" + uuid + ".jpg");
	// }else{
	// return null;
	// }
	// }
