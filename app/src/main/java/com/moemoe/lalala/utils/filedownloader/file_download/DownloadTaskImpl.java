...
import com.moemoe.lalala.utils.filedownloader.file_download.file_saver.FileSaver;
import com.moemoe.lalala.utils.filedownloader.file_download.file_saver.FileSaver.FileSaveException;
import com.moemoe.lalala.utils.filedownloader.file_download.file_saver.FileSaver.OnFileSaveListener;
import com.moemoe.lalala.utils.filedownloader.file_download.http_downloader.ContentLengthInputStream;
import com.moemoe.lalala.utils.filedownloader.file_download.http_downloader.HttpDownloader;
import com.moemoe.lalala.utils.filedownloader.file_download.http_downloader.HttpDownloader.OnHttpDownloadListener;
import com.moemoe.lalala.utils.filedownloader.file_download.http_downloader.HttpDownloader.OnRangeChangeListener;
import com.moemoe.lalala.utils.filedownloader.file_download.http_downloader.Range;
    ...
    public boolean onRangeChanged(Range oldRange, Range newRange) {
        ...
        if (Range.isLegal(newRange)) {
            ...
            if (newRange.startPos > oldRange.startPos && oldRange.startPos >= 0) {
                ...
                // legal, need update the start pos in record, the downloadedSize in NetaDownloadInfo
                try {
