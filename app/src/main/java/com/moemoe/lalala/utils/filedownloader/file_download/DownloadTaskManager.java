package com.moemoe.lalala.utils.filedownloader.file_download;

import android.text.TextUtils;

import com.moemoe.lalala.utils.filedownloader.DownloadConfiguration;
import com.moemoe.lalala.utils.filedownloader.DownloadConfiguration.Builder;
import com.moemoe.lalala.utils.filedownloader.DownloadFileInfo;
import com.moemoe.lalala.utils.filedownloader.DownloadStatusConfiguration;
import com.moemoe.lalala.utils.filedownloader.FileDownloadConfiguration;
import com.moemoe.lalala.utils.filedownloader.base.Log;
import com.moemoe.lalala.utils.filedownloader.base.Status;
import com.moemoe.lalala.utils.filedownloader.file_download.base.DownloadRecorder;
import com.moemoe.lalala.utils.filedownloader.file_download.base.DownloadTask;
import com.moemoe.lalala.utils.filedownloader.file_download.base.OnStopFileDownloadTaskListener;
import com.moemoe.lalala.utils.filedownloader.file_download.base.OnStopFileDownloadTaskListener.StopDownloadFileTaskFailReason;
import com.moemoe.lalala.utils.filedownloader.file_download.base.OnTaskRunFinishListener;
import com.moemoe.lalala.utils.filedownloader.file_download.base.Pauseable;
import com.moemoe.lalala.utils.filedownloader.listener.OnDetectBigUrlFileListener;
import com.moemoe.lalala.utils.filedownloader.listener.OnDetectBigUrlFileListener.DetectBigUrlFileFailReason;
import com.moemoe.lalala.utils.filedownloader.listener.OnDetectUrlFileListener;
import com.moemoe.lalala.utils.filedownloader.listener.OnDetectUrlFileListener.DetectUrlFileFailReason;
import com.moemoe.lalala.utils.filedownloader.listener.OnFileDownloadStatusListener;
import com.moemoe.lalala.utils.filedownloader.listener.OnFileDownloadStatusListener.FileDownloadStatusFailReason;
import com.moemoe.lalala.utils.filedownloader.listener.OnFileDownloadStatusListener.OnFileDownloadStatusFailReason;
import com.moemoe.lalala.utils.filedownloader.util.CollectionUtil;
import com.moemoe.lalala.utils.filedownloader.util.DownloadFileUtil;
import com.moemoe.lalala.utils.filedownloader.util.FileUtil;
import com.moemoe.lalala.utils.filedownloader.util.NetworkUtil;
import com.moemoe.lalala.utils.filedownloader.util.UrlUtil;
...
public class DownloadTaskManager implements Pauseable {
    ...
    private DownloadTask getRunningDownloadTask(String url, boolean includeStopped) {
        ...
        // not in recorder, maybe the NetaDownloadInfo not create(download status before prepared), look up the
    ...
    private void createAndStartByDetectUrlFile(String callerUrl, DetectUrlFileInfo detectUrlFileInfo,
        ...
        // delete detected file if succeed create NetaDownloadInfo
        if (DownloadFileUtil.isLegal(downloadFileInfo)) {
