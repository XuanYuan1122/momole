...
public class L2DExpressionMotion extends AMotion {
    ...
    public static L2DExpressionMotion loadJson(byte[] buf ) throws Exception
    {
        ...
        Json.Value params = json.get("params");
    ...
    static public HashMap<String,AMotion> loadExpressionJsonV09(InputStream in ) throws Exception
    {
        ...
        Json.Value mo = Json.parseFromBytes( buf ) ;

        Json.Value defaultExpr = mo.get(EXPRESSION_DEFAULT) ;
    ...
    static private L2DExpressionMotion loadJsonV09( Json.Value defaultExpr , Json.Value expr ){
        ...
        Json.Value defaultParams = defaultExpr.get("PARAMS") ;
        Json.Value params = expr.get("PARAMS") ;
