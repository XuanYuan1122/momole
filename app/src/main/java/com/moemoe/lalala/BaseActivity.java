...
public abstract class BaseActivity extends AppCompatActivity{
    ...
    protected void showUpdateDialog(final AppUpdateInfo info){
        ...
        alertDialogUtil.createPromptDialog(this, info.title, info.content);
        alertDialogUtil.setButtonText(getString(R.string.label_update), getString(R.string.label_later), info.updateStatus);
