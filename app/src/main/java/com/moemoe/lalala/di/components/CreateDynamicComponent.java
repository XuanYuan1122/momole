 ...
 */
@UserScope
@Component(modules = CreateDynamicModule.class,dependencies = NetComponent.class)
public interface CreateDynamicComponent {
    void inject(CreateDynamicActivity activity);
}
