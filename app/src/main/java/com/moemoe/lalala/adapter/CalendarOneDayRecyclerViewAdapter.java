 ...
 */
public class CalendarOneDayRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements IPlayBack.Callback{
   ...
   // private MusicServiceManager mServiceManager;
    ...
    public CalendarOneDayRecyclerViewAdapter(Context context){
        mContext = context;
...
//                if(musicInfo == null){
//                    musicInfo = new Song();
//                    musicInfo.setDisplayName(doc.musicName);
//                   // musicInfo.position = position;
//                    musicInfo.setPath(doc.musicUrl);
//                    musicInfo.setCoverPath(doc.icon.path);
//                    //mServiceManager.addMusicInfo(musicInfo);
//                }
               // final Song cur = musicInfo;
                linearVViewHolder.mIvVideo.setVisibility(View.VISIBLE);
                if(mPlayer.isPlaying()){
                    Song musicInfo = mPlayer.getPlayingSong();
                    if(musicInfo.getPath().equals(doc.musicUrl)){
...
//                }
                linearVViewHolder.mIvVideo.setOnClickListener(new NoDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View v) {
                        Song musicInfo = mPlayer.getPlayingSong();
                        if(mPlayer.isPlaying() && musicInfo.getPath().equals(doc.musicUrl)){
                            mPlayer.pause();
                            linearVViewHolder.mIvVideo.setImageResource(R.drawable.icon_video_play);
                        }else if(musicInfo != null && musicInfo.getPath().equals(doc.musicUrl)){
                            mPlayer.play();
                            linearVViewHolder.mIvVideo.setImageResource(R.drawable.icon_video_stop);
                        }else {
                            Song song = new Song();
                            song.setCoverPath(doc.icon.path);
                            song.setDisplayName(doc.musicName);
                            song.setPath(doc.musicUrl);
