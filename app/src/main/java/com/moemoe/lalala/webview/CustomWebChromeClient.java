...
public class CustomWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
   ...
   // private View loadingView;
    ...
    public CustomWebChromeClient(BaseAppCompatActivity activity){
        super();
        mActivity = activity;
    }

    @SuppressWarnings("unused")
    public CustomWebChromeClient(BaseAppCompatActivity activity, View activityNonVideoView, ViewGroup activityVideoView) {
        mActivity = activity;
    ...
    @SuppressWarnings("unused")
    public CustomWebChromeClient(BaseAppCompatActivity activity, View activityNonVideoView, ViewGroup activityVideoView, View loadingView) {
        mActivity = activity;
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
    ...
    public CustomWebChromeClient(BaseAppCompatActivity activity, View activityNonVideoView, ViewGroup activityVideoView, View loadingView, CustomWebView webView) {
        mActivity = activity;
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
       // this.loadingView = loadingView;
