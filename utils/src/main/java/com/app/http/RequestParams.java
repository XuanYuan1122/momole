...
import com.app.common.task.Priority;
import com.app.common.util.KeyValue;
import com.app.common.util.LogUtil;
import com.app.http.app.DefaultParamsBuilder;
import com.app.http.app.HttpRetryHandler;
import com.app.http.app.ParamsBuilder;
import com.app.http.app.RedirectHandler;
import com.app.http.body.BodyItemWrapper;
import com.app.http.body.FileBody;
import com.app.http.body.InputStreamBody;
import com.app.http.body.MultipartBody;
import com.app.http.body.RequestBody;
import com.app.http.body.StringBody;
import com.app.http.body.UrlEncodedParamsBody;
...
public class RequestParams {
    ...
    public void setBuildUrl(String uri){ this.buildUri = uri; }

    public void setBuilder(ParamsBuilder builder){
        this.builder = builder;
    }
