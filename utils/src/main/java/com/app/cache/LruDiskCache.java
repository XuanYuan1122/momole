...
import com.app.common.util.ProcessLock;
import com.app.config.DbConfigs;
...
public final class LruDiskCache {
    ...
    private static final String CACHE_DIR_NAME = "utils_cache";
    ...
    private LruDiskCache(String dirName) {
        this.cacheDb = Utils.getDb(DbConfigs.HTTP.getConfig());
