...
import com.app.ex.FileLockedException;
...
/*package*/ final class ImageLoader implements
    ...
    private final static String DISK_CACHE_DIR_NAME = "utils_img";
    ...
    static {
        int memClass = ((ActivityManager) Utils.app()
    ...
    static Cancelable doLoadFile(final String url,
        ...
        return Utils.http().get(params, callback);
    }
    ...
    private Cancelable doLoad(ImageView view,
        ...
        return cancelable = Utils.http().get(params, this);
    }
    ...
    private static void postBindArgsException(
        ...
        Utils.task().autoPost(new Runnable() {
            @Override
            public void run() {
                try {
                    if (callback instanceof ProgressCallback) {
